class skyui.defines.Input
{
	...
	static var DEVICE_VIVE_PRIMARY: Number = 3;
	static var DEVICE_VIVE_SECONDARY: Number  = 4;
	static var DEVICE_OCULUS_PRIMARY: Number = 5;
	static var DEVICE_OCULUS_SECONDARY: Number = 6;
	static var DEVICE_WINDOWS_MR_PRIMARY: Number = 7;
	static var DEVICE_WINDOWS_MR_SECONDARY: Number = 8;
	static var DEVICE_VIRTUAL_KEYBOARD: Number = 9;

	static var MOTION_CONTROLLER_VIVE: Number = 0;
	static var MOTION_CONTROLLER_OCULUS: Number = 1;
	static var MOTION_CONTROLLER_WINDOWS_MR: Number = 2;
	...
	static var CONTEXT_CRAFTINGMENU: Number	= 17;
	static var CONTEXT_BARTERMENU: Number	= 18;
	static var CONTEXT_RACESEXMENU: Number  = 19;
	static var CONTEXT_DIALOGUEMENU: Number	= 20;
