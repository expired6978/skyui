intrinsic class skse
{
	...
	static function IsUsingMotionControllers():Boolean;
	static function IsLeftHanded():Boolean;
	static function GetMotionControllerType():Number;
	static function ShowVirtualKeyboard(a_overlayKey: String, a_title: String, a_description:String, a_startText: String, a_receiver: Object, callback: Function):Boolean;
