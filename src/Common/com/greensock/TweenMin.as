...
/**
 *  TweenMin extends the extremely lightweight, fast TweenLite engine, adding many useful features
 * 	like timeScale, event listeners, updateTo(), yoyo, repeat, repeatDelay, rounding, and more. It also 
 * 	activates many extra plugins by default, making it extremely full-featured. Since TweenMin extends 
 * 	TweenLite, it can do ANYTHING TweenLite can do plus much more. The syntax is identical. With plenty 
 *  of other tweening engines to choose from, here's why you might want to consider TweenMin: 
 * 
 * <ul>
 * 		<li><b> SPEED </b>- TweenMin has been highly optimized for maximum performance. See some speed comparisons yourself at 
 * 			 <a href="http://www.greensock.com/tweening-speed-test/">http://www.greensock.com/tweening-speed-test/</a></li>
 * 
 * 	    <li><b> Feature set </b>- In addition to tweening ANY numeric property of ANY object, TweenMin can tween filters, 
 ...
 * 										several modes to choose from, and TweenMin automatically calls <code>OverwriteManager.init()</code> if you haven't
 ...
 * 													
 * 											<li>AUTO (2) - this is the default mode for TweenMin.</li>
 * 												
 * 											<li>CONCURRENT (3)</li>
 * 												
 * 											<li>ALL_ONSTART (4)</li>
 ...
 * 	
 * 	<li><b> startAt : Object</b>				Allows you to define the starting values for each property. Typically, TweenMin uses the current
 ...
 * 												tween it from 0 to 500, do <code>TweenMin.to(mc, 2, {_x:500, startAt:{_x:0}});</code> </li>
 * </ul>
 * 
 * <b>PLUGINS: </b><br /><br />
 * 
 ...
 * 	Get information about all the plugins at <a href="http://www.TweenMin.com">http://www.TweenMin.com</a>. The 
 *  following plugins are activated by default in TweenMin (you can easily prevent them from activating, thus 
 ...
 * 					  			  to end up at(or begin at if you're using TweenMin.from()). An example hex value would be 0xFF0000.</li>
 * 					  
 ...
 * 					   			  <code>TweenMin.to(my_mc, 3, {_x:500, _y:0, bezier:[{_x:250, _y:50}]});</code></li>
 * 					   
 ...
 * 							makes it easy. In order to alter a rotation property accurately, TweenMin needs 4 pieces
 * 							of information: 
 * 							<ol>
 ...
 * 							in a boolean value of true and TweenMin will use a typical setup, <code>[["_x", "_y", "_rotation", 0]]</code>. 
 ...
 * 				 blue components must be extracted and tweened independently. TweenMin makes it easy. To tween
 * 				 a property of your object that's a hex color to another hex color, use this special hexColors 
 * 				 property of TweenMin. It must be an OBJECT with properties named the same as your object's 
 ...
 * 				 <code>TweenMin.to(my_obj, 2, {hexColors:{myHexColor:0xFF0000}});</code><br />
 ...
 * 	  					   every time the tween is rendered, you'd do: <code>TweenMin.to(mc, 2, {_x:300, _y:200, _alpha:50, roundProps:["_x","_y"]});</code></li>
 * 	  					   
 ...
 * 		
 * 		import com.greensock.TweenMin;<br /> 
 * 		import com.greensock.easing.Back;<br /><br />
 * 
 * 		TweenMin.to(mc, 5, {_alpha:50, _x:120, ease:Back.easeOut, delay:2, onComplete:onFinishTween, onCompleteParams:[5, mc]});<br /> 
 ...
 * 
 * 		TweenMin.from(mc, 5, {_y:"-100", ease:Elastic.easeOut});</code><br /><br />
 * 
 * 
 * <b>NOTES / TIPS:</b>
 * <ul>
 * 	<li> Passing values as Strings will make the tween relative to the current value. For example, if you do
 * 	  <code>TweenMin.to(mc, 2, {_x:"-20"});</code> it'll move the mc._x to the left 20 pixels which is the same as doing
 * 	  <code>TweenMin.to(mc, 2, {_x:mc._x - 20});</code> You could also cast it like: <code>TweenMin.to(mc, 2, {_x:String(myVariable)});</code></li>
 * 	  
 * 	<li> You can kill all tweens of a particular object anytime with the <code>TweenMin.killTweensOf(myObject); </code>
 * 	  function. If you want to have the tweens forced to completion, pass true as the second parameter, 
 * 	  like <code>TweenMin.killTweensOf(myObject, true);</code></li>
 * 	  
 * 	<li> You can kill all delayedCalls to a particular function using <code>TweenMin.killDelayedCallsTo(myFunction);</code>
 * 	  This can be helpful if you want to preempt a call.</li>
 * 	  
 * 	<li> Use the TweenMin.from() method to animate things into place. For example, if you have things set up on 
...
class com.greensock.TweenMin extends TweenLite {
		/** @private **/
		...
		private static var _activatedPlugins:Boolean = TweenPlugin.activate([
			...
			//RoundPropsPlugin,			//enables the roundProps special property for rounding values (ONLY for TweenMin!)
		...
		/** @private OverwriteManager is optional for TweenLite but it is used by default in TweenMin so we init it here (if it isn't already enabled).**/
		 ...
		 */
		public function TweenMin(target:Object, duration:Number, vars:Object) {
			super(target, duration, vars);
			if (TweenLite.version < 11.2) {
				trace("TweenMin warning: Please update your TweenLite class or try deleting your ASO files. TweenMin requires a more recent version. Download updates at http://www.TweenMin.com.");
			}
		...
		private function init():Void {
			if (this.vars.startAt) {
				...
				var startTween:TweenMin = new TweenMin(this.target, 0, this.vars.startAt);
			}
			super.init();
		}
		 ...
		 * 
		 * //create the tween <br />
		 * var tween:TweenMin = new TweenMin(mc, 2, {_x:100, _y:200, _alpha:50});<br /><br />
		 * 
		...
		public function renderTime(time:Number, suppressEvents:Boolean, force:Boolean):Void {
			...
			if (time >= totalDur) {
				...
				} else if (time == 0 && !this.initted) { //if we render the very beginning (time == 0) of a TweenMin.fromTo(), we must force the render (normal tweens wouldn't need to render at a time of 0 when the prevTime was also 0). This is also mandatory to make sure overwriting kicks in immediately.
					force = true;
				}
...
//---- STATIC FUNCTIONS -----------------------------------------------------------------------------------------------------------
		...
		/**
		 * Static method for creating a TweenMin instance. This can be more intuitive for some developers 
		 ...
		 * 
		 * 		var myTween:TweenMin = new TweenMin(mc, 1, {_x:100}); <br />
		 * 		TweenMin.to(mc, 1, {_x:100}); <br />
		 * 		var myTween:TweenMin = TweenMin.to(mc, 1, {_x:100}); <br /><br /></code>
		 * 
		 * @param target Target object whose properties this tween affects. This can be ANY object, not just a MovieClip. 
		 * @param duration Duration in seconds (or in frames if the tween's timing mode is frames-based)
		 * @param vars An object containing the end values of the properties you're tweening. For example, to tween to _x=100, _y=100, you could pass {_x:100, _y:100}. It can also contain special properties like "onComplete", "ease", "delay", etc.
		 * @return TweenMin instance
		 */
		public static function to(target:Object, duration:Number, vars:Object):TweenMin {
			return new TweenMin(target, duration, vars);
		}
		
		/**
		 * Static method for creating a TweenMin instance that tweens in the opposite direction
		 * compared to a TweenMin.to() tween. In other words, you define the START values in the 
		 ...
		 * because you can build them in their end positions and do some simple TweenMin.from()
		 ...
		 * 
		 * TweenMin.from(mc, 1.5, {_alpha:0, delay:2});</code>
		 * 
		 * @param target Target object whose properties this tween affects. This can be ANY object, not just a MovieClip. 
		 * @param duration Duration in seconds (or in frames if the tween's timing mode is frames-based)
		 ...
		 * @return TweenMin instance
		 */
		public static function from(target:Object, duration:Number, vars:Object):TweenMin {
		...
		/**
		 * Static method for creating a TweenMin instance that tweens from a particular set of
		 ...
		 * @return TweenMin instance
		 */
		public static function fromTo(target:Object, duration:Number, fromVars:Object, toVars:Object):TweenMin {
			toVars.startAt = fromVars;
			if (fromVars.immediateRender) {
				toVars.immediateRender = true;
			}
			return new TweenMin(target, duration, toVars);
		}
		 ...
		 * TweenMin.allTo([mc1, mc2, mc3, mc4, mc5], 1, {_y:"100", _alpha:0}, 0.2); <br /><br />
		 * 
		 ...
		 * <code>myTimeline.insertMultiple(TweenMin.allTo([mc1, mc2, mc3], 1, {_alpha:0, _y:"100"}, 0.1));</code>
		 * 
		 ...
		 * @param vars An object containing the end values of all the properties you'd like to have tweened (or if you're using the TweenMin.allFrom() method, these variables would define the BEGINNING values).
		 * @param stagger Staggers the start time of each tween. For example, you might want to have 5 MovieClips move down 100 pixels while fading out, and stagger the start times slightly by 0.2 seconds, you could do: <code>TweenMin.allTo([mc1, mc2, mc3, mc4, mc5], 1, {_y:"100", _alpha:0}, 0.2)</code>.
		 ...
		 * @return Array of TweenMin tweens
		 */
		public static function allTo(targets:Array, duration:Number, vars:Object, stagger:Number, onCompleteAll:Function, onCompleteAllParams:Array, onCompleteAllScope:Object):Array {
			...
			for (i = 0; i < l; i++) {
				...
				a[i] = new TweenMin(targets[i], duration, varsDup);
				curDelay += stagger;
			}
			return a;
		}
		...
		/**
		 * Exactly the same as TweenMin.allTo(), but instead of tweening the properties from where they're 
		 ...
		 * 
		 * TweenMin.allFrom([mc1, mc2, mc3], 1.5, {_alpha:0, delay:2}, 0.1);</code>
		 * 
		 * @param targets An Array of objects to tween.
		 * @param duration Duration (in seconds) of the tween (or in frames for frames-based tweens)
		 * @param vars An object containing the start values of all the properties you'd like to have tweened.
		 * @param stagger Staggers the start time of each tween. For example, you might want to have 5 MovieClips move down 100 pixels while fading from _alpha:0, and stagger the start times slightly by 0.2 seconds, you could do: <code>TweenMin.allFromTo([mc1, mc2, mc3, mc4, mc5], 1, {_y:"-100", _alpha:0}, 0.2)</code>.
		 * @param onCompleteAll A function to call when all of the tweens have completed.
		 * @param onCompleteAllParams An Array of parameters to pass the onCompleteAll function when all the tweens have completed.
		 * @return Array of TweenMin instances
		 */
		 ...
		 * as TweenMin.allTo(), but adds the ability to define the starting values. <b>NOTE</b>: Only put starting values
		 ...
		 * @param stagger Staggers the start time of each tween. For example, you might want to have 5 MovieClips move down from _y:0 to _y:100 while fading from _alpha:0 to _alpha:100, and stagger the start times slightly by 0.2 seconds, you could do: <code>TweenMin.allFromTo([mc1, mc2, mc3, mc4, mc5], 1, {_y:0, _alpha:0}, {_y:100, _alpha:100}, 0.2)</code>.
		 * @param onCompleteAll A function to call when all of the tweens have completed.
		 * @param onCompleteAllParams An Array of parameters to pass the onCompleteAll function when all the tweens have completed.
		 * @return Array of TweenMin instances
		 */
		 ...
		 * 
		 * 		TweenMin.delayedCall(1, myFunction, ["param1", 2]);<br />
		 ...
		 * @return TweenMin instance
		 */
		public static function delayedCall(delay:Number, onComplete:Function, onCompleteParams:Array, onCompleteScope:Object, useFrames:Boolean):TweenMin {
			return new TweenMin(onComplete, 0, {delay:delay, onComplete:onComplete, onCompleteParams:onCompleteParams, onCompleteScope:onCompleteScope, immediateRender:false, useFrames:useFrames, overwrite:0});
		}
		 ...
		 * @return Array of tweens (could be TweenLite and/or TweenMin instances)
		 */
		 ...
		 * 
		 * @return Array of TweenLite and/or TweenMin instances
		 */
		...
		/**
		 * Pauses all TweenMin tweens and/or delayedCalls/callbacks.
		 * 
		 * @param tweens If true, all TweenMin instances should be paused.
		...
		/**
		 * Resumes all paused TweenMin tweens and/or delayedCalls/callbacks.
		 * 
		...
		/**
		 * @private
		 * Changes the paused state of all TweenMin tweens and/or delayedCalls
		 * 
		 * @param pause Desired paused state
		 * @param tweens If true, all TweenMin instances should be affected.
...
//---- GETTERS / SETTERS ----------------------------------------------------------------------------------------------------------
		 ...
		 * Value between 0 and 1 indicating the progress of the tween according to its duration 
 		 ...
 		 * which includes repeats and repeatDelays (if there are any). For example, if a TweenMin instance 
		 ...
		 * Value between 0 and 1 indicating the progress of the tween according to its totalDuration 
 		 ...
 		 * include repeats and repeatDelays. For example, if a TweenMin instance is set to repeat 
